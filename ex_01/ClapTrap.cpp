...
ClapTrap::ClapTrap(std::string name, unsigned int hitPoints, unsigned int energyPoints, unsigned int attackDemage) 
	: _name(name), _hitPoints(hitPoints), _energyPoints(energyPoints), _attackDemage(attackDemage){
		std::cout << "ClapTrap Parametarized Constructor Called for " << this->_name << std::endl;
	}
